...
import { FaBed, FaMoneyBill, FaToilet } from "react-icons/all";
...
export default function UploadRoom() {
  ...
  const { data: categories, isLoading: isCategoiresLoading } = useQuery<
    ICategory[]
          ...
          <VStack spacing={10} as="form" mt={5}>
            ...
            <FormControl>
              ...
              <Select placeholder="Choose a kind">
                ...
                <option value="shared_room">Shared Place</option>
              </Select>
              <FormHelperText>
